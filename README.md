...
Модели создаются с учетом особенностей работы с банковскими транзакциями и временными рядами (вводится **задержка** между периодами обучения, валидации и оценки моделей; используется предварительная валидация (**prequential validation**) со скользящим окном).
...
Дополнительно оценивается целесообразность применения техник для работы с несаблансированными датасетами:
